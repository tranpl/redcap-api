...
You can see here the Death Star orbiting the forest Moon of Endor. Although the weapon systems on this Death Star are not yet operational, the Death Star does have a strong defense mechanism. It is protected by an energy shield, which is generated from the nearby forest Moon of Endor. The shield must be deactivated if any attack is to be attempted. Once the shield is down, our cruisers will create a perimeter, while the fighters fly into the superstructure and attempt to knock out the main reactor. General Calrissian has volunteered to lead the fighter attack";
        ...
        static async Task Main(string[] args)
        {
            ...
            //var GetRecordAsync = redcapApi.GetRecordAsync("1", ReturnFormat.json, RedcapDataType.flat, OnErrorFormat.json, null, null, null, null);
            ...
            //var exportEvents = redcapApi.ExportEventsAsync(ReturnFormat.json, OnErrorFormat.json);
            ...
            //var GetRecordsAsync = redcapApi.GetRecordsAsync(ReturnFormat.json, OnErrorFormat.json, RedcapDataType.flat);
            ...
            //var GetRedcapVersionAsync = redcapApi.GetRedcapVersionAsync(ReturnFormat.json, RedcapDataType.flat);
            ...
            //var SaveRecordsAsync = redcapApi.SaveRecordsAsync(saveRecordsAsyncObject, ReturnContent.ids, OverwriteBehavior.overwrite, ReturnFormat.json, RedcapDataType.flat, OnErrorFormat.json);
            ...
            //var ExportRecordsAsync = redcapApi.ExportRecordsAsync(_token);
            ...
            //var ExportArmsAsync = redcapApi.ExportArmsAsync(ReturnFormat.json, OnErrorFormat.json);
            ...
            //Console.WriteLine("Calling ExportRecordsAsync() . . .");
            //var ExportRecordsAsync2 = redcapApi.ExportRecordsAsync(_token, Content.Record);
            ...
            //var ImportEventsAsync = redcapApi.ImportEventsAsync(listOfEvents, Override.False, ReturnFormat.json, OnErrorFormat.json);
            ...
            //var ImportFile = redcapApi.ImportFileAsync(_uri, Content.File, RedcapAction.Import, record, fieldName, eventName, repeatingInstrument, importFileName, pathImport, OnErrorFormat.json);
            //Console.WriteLine($"File has been imported! To verify, field history!");

            //Console.WriteLine("Calling ExportFile() . . .");
            //var ExportFile = redcapApi.ExportFileAsync(_uri, Content.File, RedcapAction.Import, record, fieldName, eventName, repeatingInstrument, OnErrorFormat.json, pathExport);
            //Console.WriteLine($"ExportFile Result: {ExportFile} to : {pathExport}");

            //Console.WriteLine("Calling DeleteFile() . . .");
            //var DeleteFile = redcapApi.DeleteFileAsync("1", "protocol_upload", "event_1_arm_1", "", OnErrorFormat.json);
        ...
        static async Task InitializeDemo()
        {
            ...
            */
            ...
            var redcap_api_1_2_0 = new RedcapApi(_uri);
            ...
            var ExportLoggingAsync = await redcap_api_1_2_0.ExportLoggingAsync(_token, Content.Log, ReturnFormat.json, LogType.User);
            ...
            var ImportDagsAsyncResult = await redcap_api_1_2_0.ImportDagsAsync(_token, Content.Dag, RedcapAction.Import, ReturnFormat.json, dags);
            ...
            var ExportDagsAsyncResult = await redcap_api_1_2_0.ExportDagsAsync(_token, Content.Dag, ReturnFormat.json);
            ...
            var DeleteDagsAsyncResult = await redcap_api_1_2_0.DeleteDagsAsync(_token, Content.Dag, RedcapAction.Delete, dagsToDelete);
            ...
            var ImportRecordsAsync = await redcap_api_1_2_0.ImportRecordsAsync(_token, Content.Record, ReturnFormat.json, RedcapDataType.flat, OverwriteBehavior.normal, false, importDemographicsData, "MDY", CsvDelimiter.tab, ReturnContent.count, OnErrorFormat.json);
            ...
            var ExportRecordsAsyncResult = await redcap_api_1_2_0.ExportRecordsAsync(_token, Content.Record, ReturnFormat.json, RedcapDataType.flat, recordsToExport, null, instrumentName);
            ...
            var DeleteRecordsAsync = await redcap_api_1_2_0.DeleteRecordsAsync(_token, Content.Record, RedcapAction.Delete, recordsToExport, 1);
            ...
            var arms = new string[] { };
            Console.WriteLine("Calling ExportArmsAsync()");
            var ExportArmsAsyncResult = await redcap_api_1_2_0.ExportArmsAsync(_token, Content.Arm, ReturnFormat.json, arms, OnErrorFormat.json);
            ...
            var ImportArmsAsyncResult = await redcap_api_1_2_0.ImportArmsAsync(_token, Content.Arm, Override.False, RedcapAction.Import, ReturnFormat.json, ImportArmsAsyncData, OnErrorFormat.json);
            ...
            var DeleteArmsAsyncResult = await redcap_api_1_2_0.DeleteArmsAsync(_token, Content.Arm, RedcapAction.Delete, DeleteArmsAsyncData);
            ...
            Console.WriteLine("Calling ExportEventsAsync()");
            var ExportEventsAsyncResult = await redcap_api_1_2_0.ExportEventsAsync(_token, Content.Event, ReturnFormat.json, ExportEventsAsyncData, OnErrorFormat.json);
            ...
            var ImportEventsAsyncResult = await redcap_api_1_2_0.ImportEventsAsync(_token, Content.Event, RedcapAction.Import, Override.False, ReturnFormat.json, eventList, OnErrorFormat.json);
            ...
            var DeleteEventsAsyncResult = await redcap_api_1_2_0.DeleteEventsAsync(_token, Content.Event, RedcapAction.Delete, DeleteEventsAsyncData);
            ...
            var ExportFieldNamesAsyncResult = await redcap_api_1_2_0.ExportFieldNamesAsync(_token, Content.ExportFieldNames, ReturnFormat.json, "first_name", OnErrorFormat.json);
            ...
            var ImportFileAsyncResult = await redcap_api_1_2_0.ImportFileAsync(_token, Content.File, RedcapAction.Import, recordId, fieldName, eventName, null, fileName, filePath, OnErrorFormat.json);
            ...
            var ExportFileAsyncResult = await redcap_api_1_2_0.ExportFileAsync(_token, Content.File, RedcapAction.Export, recordId, fieldName, eventName, null, OnErrorFormat.json);
            ...
            var ExportFileAsyncResult2 = await redcap_api_1_2_0.ExportFileAsync(_token, Content.File, RedcapAction.Export, recordId, fieldName, eventName, null, OnErrorFormat.json, filedDownloadPath);
            ...
            var DeleteFileAsyncResult = await redcap_api_1_2_0.DeleteFileAsync(_token, Content.File, RedcapAction.Delete, recordId, fieldName, eventName, "1", OnErrorFormat.json);
            ...
            var ExportInstrumentsAsyncResult = await redcap_api_1_2_0.ExportInstrumentsAsync(_token, Content.Instrument, ReturnFormat.json);
            ...
            var ExportPDFInstrumentsAsyncResult2 = await redcap_api_1_2_0.ExportPDFInstrumentsAsync(_token, recordId, eventName, "demographics", true, filedDownloadPath, OnErrorFormat.json);
            ...
            var ImportInstrumentMappingAsyncResult = await redcap_api_1_2_0.ImportInstrumentMappingAsync(_token, Content.FormEventMapping, ReturnFormat.json, importInstrumentMappingData, OnErrorFormat.json);
            ...
            var ExportMetaDataAsyncResult = await redcap_api_1_2_0.ExportMetaDataAsync(_token, Content.MetaData, ReturnFormat.json, null, null, OnErrorFormat.json);
            ...
            var CreateProjectAsyncResult = await redcap_api_1_2_0.CreateProjectAsync(_superToken, Content.Project, ReturnFormat.json, projectData, OnErrorFormat.json, null);
            ...
            var ImportProjectInfoAsyncResult = await redcap_api_1_2_0.ImportProjectInfoAsync(_token, Content.ProjectSettings, ReturnFormat.json, projectInfo);
            ...
            var ExportProjectInfoAsyncResult = await redcap_api_1_2_0.ExportProjectInfoAsync(_token, Content.ProjectSettings, ReturnFormat.json);
