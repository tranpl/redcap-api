...
namespace Redcap.Interfaces
{
    ...
    public interface IRedcap
    {
        ...
        /// <param name="timeOutSeconds">Number of seconds before the http request tiems out.</param>
        /// <returns>the number of records deleted or (if instrument, event, and/or instance are provided) the number of items deleted over the total records specified.</returns>
        Task<string> DeleteRecordsAsync(string token, Content content, RedcapAction action, string[] records, int? arm, CancellationToken cancellationToken = default, long timeOutSeconds = 100, bool deleteLogging = false);
        ...
        /// <param name="content">randomization</param>
        ...
        Task<string> RandomizeRecord(string token, Content content, RedcapAction action, string record, string randomizationId, RedcapFormat format, RedcapReturnFormat returnFormat = RedcapReturnFormat.json, bool returnAlt = false, CancellationToken cancellationToken = default, long timeOutSeconds = 100);
        ...
        /// <param name="timeOutSeconds">Number of seconds before the http request tiems out.</param>
        /// <returns>Returns a unique survey participant identifier in plain text format for the specified record and instrument (and event, if longitudinal).</returns>
        Task<string> ExportSurveyAccessCodeAsync(string token, Content content, string record, string instrument, string eventName, int repeatInstance, RedcapReturnFormat returnFormat = RedcapReturnFormat.json, CancellationToken cancellationToken = default, long timeOutSeconds = 100);
