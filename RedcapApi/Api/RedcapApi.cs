    ...
    public class RedcapApi : IRedcap
    {
        ...
        public async Task<string> ExportArmsAsync(string token, RedcapFormat format = RedcapFormat.json, string[] arms = null, RedcapReturnFormat returnFormat = RedcapReturnFormat.json)
        {
            try
            {
                ...
                {
                    { "token", token },
                    { "content", RedcapContent.Arm.GetDisplayName() },
        ...
        /// <param name="returnFormat">csv, json, xml - specifies the format of error messages. If you do not pass in this flag, it will select the default format for you passed based on the 'format' flag you passed in or if no format flag was passed in, it will default to 'json'.</param>
        /// <returns>Arms for the project in the format specified(only ones with Events available)</returns>
        public async Task<string> ExportArmsAsync(string token, RedcapContent content = RedcapContent.Arm, RedcapFormat format = RedcapFormat.json, string[] arms = null, RedcapReturnFormat returnFormat = RedcapReturnFormat.json)
        {
            try
            {
                /*
        ...
        /// <param name="returnFormat">csv, json, xml - specifies the format of error messages. If you do not pass in this flag, it will select the default format for you passed based on the 'format' flag you passed in or if no format flag was passed in, it will default to 'xml'.</param>
        /// <returns>Number of Arms imported</returns>
        public async Task<string> ImportArmsAsync<T>(string token, RedcapContent content, Override overrideBhavior, RedcapAction action, RedcapFormat format, List<T> data, RedcapReturnFormat returnFormat = RedcapReturnFormat.json)
        {
            try
            {
                /*
        ...
        /// <param name="arms">an array of arm numbers that you wish to delete</param>
        /// <returns>Number of Arms deleted</returns>
        public async Task<string> DeleteArmsAsync(string token, RedcapContent content = RedcapContent.Event, RedcapAction action = RedcapAction.Delete, string[] arms = default)
        {
            try
            {
                /*
        ...
        public async Task<string> ExportDagsAsync(string token, RedcapContent content = RedcapContent.Dag, RedcapFormat format = RedcapFormat.json, RedcapReturnFormat returnFormat = RedcapReturnFormat.json)
        {
        ...
        public async Task<string> ImportDagsAsync<T>(string token, RedcapContent content, RedcapAction action, RedcapFormat format, List<T> data, RedcapReturnFormat returnFormat = RedcapReturnFormat.json)
        {
        ...
        public async Task<string> DeleteDagsAsync(string token, RedcapContent content, RedcapAction action, string[] dags)
        {
        ...
        public async Task<string> SwitchDagAsync(string token, RedcapDag dag, RedcapContent content = RedcapContent.Dag, RedcapAction action = RedcapAction.Switch)
        {
        ...
        public async Task<string> ExportUserDagAssignmentAsync(string token, RedcapContent content, RedcapFormat format = RedcapFormat.json, RedcapReturnFormat returnFormat = RedcapReturnFormat.json)
        {
        ...
        public async Task<string> ImportUserDagAssignmentAsync<T>(string token, RedcapContent content, RedcapAction action, RedcapFormat format, List<T> data, RedcapReturnFormat returnFormat = RedcapReturnFormat.json)
        {
        ...
        public async Task<string> ExportEventsAsync(string token, RedcapFormat format, string[] arms, RedcapReturnFormat returnFormat = RedcapReturnFormat.json)
        {
            try
            {
                ...
                {
                    { "token", token },
                    { "content", RedcapContent.Event.GetDisplayName() },
                    { "format", format.GetDisplayName() },
                    { "returnFormat", returnFormat.GetDisplayName() }
                };
                // Optional
        ...
        /// <param name="returnFormat">csv, json, xml - specifies the format of error messages. If you do not pass in this flag, it will select the default format for you passed based on the 'format' flag you passed in or if no format flag was passed in, it will default to 'json'.</param>
        /// <returns>Events for the project in the format specified</returns>
        public async Task<string> ExportEventsAsync(string token, RedcapContent content, RedcapFormat format, string[] arms, RedcapReturnFormat returnFormat = RedcapReturnFormat.json)
        {
            try
            {
                /*
        ...
        /// <param name="returnFormat">csv, json, xml - specifies the format of error messages. If you do not pass in this flag, it will select the default format for you passed based on the 'format' flag you passed in or if no format flag was passed in, it will default to 'json'.</param>
        /// <returns>Number of Events imported</returns>
        public async Task<string> ImportEventsAsync<T>(string token, RedcapContent content, RedcapAction action, Override overrideBehavior, RedcapFormat format, List<T> data, RedcapReturnFormat returnFormat = RedcapReturnFormat.json)
        {
            try
            {
                /*
        ...
        /// <param name="events">Array of unique event names</param>
        /// <returns>Number of Events deleted</returns>
        public async Task<string> DeleteEventsAsync(string token, RedcapContent content, RedcapAction action, string[] events)
        {
            try
            {
                /*
        ...
        public async Task<string> ExportFieldNamesAsync(string token, RedcapFormat format = RedcapFormat.json, string field = default, RedcapReturnFormat returnFormat = RedcapReturnFormat.json)
        {
            try
            {
                ...
                {
                    { "token", token },
                    { "content", RedcapContent.ExportFieldNames.GetDisplayName() },
                    { "format", format.GetDisplayName() },
                    { "returnFormat", returnFormat.GetDisplayName() }
        ...
        /// The list that is returned will contain the three following attributes for each field/choice: 'original_field_name', 'choice_value', and 'export_field_name'. The choice_value attribute represents the raw coded value for a checkbox choice. For non-checkbox fields, the choice_value attribute will always be blank/empty. The export_field_name attribute represents the export/import-specific version of that field name.
        /// </returns>
        public async Task<string> ExportFieldNamesAsync(string token, RedcapContent content = RedcapContent.ExportFieldNames, RedcapFormat format = RedcapFormat.json, string field = null, RedcapReturnFormat returnFormat = RedcapReturnFormat.json)
        {
            try
            {
                /*
        ...
        public async Task<string> ExportFileAsync(string token, string record, string field, string eventName, string repeatInstance = "1", RedcapReturnFormat returnFormat = RedcapReturnFormat.json, string filePath = null)
        {
            try
            {
                ...
                {
                    { "token", token },
                    { "content", RedcapContent.File.GetDisplayName() },
        ...
        public async Task<string> ExportFileAsync(string token, RedcapContent content, RedcapAction action, string record, string field, string eventName, string repeatInstance = "1", RedcapReturnFormat onErrorFormat = RedcapReturnFormat.json, string filePath = null)
        {
            try
            {
                /*
        ...
        public async Task<string> ImportFileAsync(string token, string record, string field, string eventName, string repeatInstance, string fileName, string filePath, RedcapReturnFormat returnFormat = RedcapReturnFormat.json)
        {
            try
            {
                ...
                var payload = new MultipartFormDataContent()
                {
                        ...
                        {new StringContent(RedcapContent.File.GetDisplayName()) ,"content" },
        ...
        /// <param name="returnFormat">csv, json, xml - specifies the format of error messages. If you do not pass in this flag, it will select the default format for you passed based on the 'format' flag you passed in or if no format flag was passed in, it will default to 'xml'.</param>
        /// <returns>csv, json, xml - specifies the format of error messages. If you do not pass in this flag, it will select the default format for you passed based on the 'format' flag you passed in or if no format flag was passed in, it will default to 'json'.</returns>
        public async Task<string> ImportFileAsync(string token, RedcapContent content, RedcapAction action, string record, string field, string eventName, string repeatInstance, string fileName, string filePath, RedcapReturnFormat returnFormat = RedcapReturnFormat.json)
        {
            try
            {
                /*
        ...
        /// <param name="returnFormat">csv, json, xml - specifies the format of error messages. If you do not pass in this flag, it will select the default format for you passed based on the 'format' flag you passed in or if no format flag was passed in, it will default to 'json'.</param>
        /// <returns>String</returns>
        public async Task<string> DeleteFileAsync(string token, RedcapContent content, RedcapAction action, string record, string field, string eventName, string repeatInstance, RedcapReturnFormat returnFormat = RedcapReturnFormat.json)
        {
            try
            {
                /*
        ...
        public async Task<string> CreateFolderFileRepositoryAsync(string token, RedcapContent content, RedcapAction action, string name, RedcapFormat format, string folderId = default, string dagId = default, string roleId = default, RedcapReturnFormat returnFormat = RedcapReturnFormat.json)
        {
            /*
        ...
        public async Task<string> ExportFilesFoldersFileRepositoryAsync(string token, RedcapContent content = RedcapContent.FileRepository, RedcapAction action = RedcapAction.List, RedcapFormat format = RedcapFormat.json, string folderId = null, RedcapReturnFormat returnFormat = RedcapReturnFormat.json)
        {
            /*
             * Check the required parameters for empty or null
             */
        ...
        /// <param name="returnFormat">csv, json, xml - specifies the format of error messages. If you do not pass in this flag, it will select the default format for you passed based on the 'format' flag you passed in or if no format flag was passed in, it will default to 'json'.</param>
        /// <returns>the contents of the file</returns>
        public async Task<string> ExportFileFileRepositoryAsync(string token, RedcapContent content, RedcapAction action, string docId = default, RedcapReturnFormat returnFormat = RedcapReturnFormat.json)
        {
            /*
             * Check the required parameters for empty or null
             */
        ...
        /// <param name="returnFormat">csv, json, xml - specifies the format of error messages. If you do not pass in this flag, it will select the default format for you passed based on the 'format' flag you passed in or if no format flag was passed in, it will default to 'json'.</param>
        /// <returns>string</returns>
        public async Task<string> ImportFileRepositoryAsync(string token, RedcapContent content = RedcapContent.FileRepository, RedcapAction action = RedcapAction.Import, string file = null, string folderId = null, RedcapReturnFormat returnFormat = RedcapReturnFormat.json)
        {
            /*
             * Check the required parameters for empty or null
             */
        ...
        /// <param name="returnFormat">csv, json, xml - specifies the format of error messages. If you do not pass in this flag, it will select the default format for you passed based on the 'format' flag you passed in or if no format flag was passed in, it will default to 'json'.</param>
        /// <returns>string</returns>
        public async Task<string> DeleteFileRepositoryAsync(string token, RedcapContent content = RedcapContent.FileRepository, RedcapAction action = RedcapAction.Delete, string docId = null, RedcapReturnFormat returnFormat = RedcapReturnFormat.json)
        {
            /*
             * Check the required parameters for empty or null
             */
        ...
        public async Task<string> ExportInstrumentsAsync(string token, RedcapFormat format = RedcapFormat.json)
        {
            try
            {
                ...
                {
                    { "token", token },
                    { "content", RedcapContent.Instrument.GetDisplayName() },
                    { "format", format.GetDisplayName() }
                };
                // Execute request
                return await this.SendPostRequestAsync(payload, _uri);
        ...
        /// <param name="format">csv, json [default], xml</param>
        /// <returns>Instruments for the project in the format specified and will be ordered according to their order in the project.</returns>
        public async Task<string> ExportInstrumentsAsync(string token, RedcapContent content = RedcapContent.Instrument, RedcapFormat format = RedcapFormat.json)
        {
            try
            {
                /*
        ...
        public async Task<string> ExportPDFInstrumentsAsync(string token, string recordId = default, string eventName = default, string instrument = default, bool allRecord = false, RedcapReturnFormat returnFormat = RedcapReturnFormat.json)
        {
            try
            {
                ...
                {
                    { "token", token },
                    { "content", RedcapContent.Pdf.GetDisplayName() },
                    { "returnFormat", returnFormat.GetDisplayName() }
                };
        ...
        /// <param name="returnFormat">csv, json [default] , xml- The returnFormat is only used with regard to the format of any error messages that might be returned.</param>
        /// <returns>A PDF file containing one or all data collection instruments from the project, in which the instruments will be blank (no data), contain data from a single record, or contain data from all records in the project, depending on the parameters passed in the API request.</returns>
        public async Task<string> ExportPDFInstrumentsAsync(string token, RedcapContent content = RedcapContent.Pdf, string recordId = default, string eventName = default, string instrument = default, bool allRecords = false, bool compactDisplay = false, RedcapReturnFormat returnFormat = RedcapReturnFormat.json)
        {
            try
            {
                /*
        ...
        public async Task<string> ExportInstrumentMappingAsync(string token, RedcapFormat format = RedcapFormat.json, string[] arms = default, RedcapReturnFormat returnFormat = RedcapReturnFormat.json)
        {
            try
            {
                ...
                {
                    { "token", token },
                    { "content", RedcapContent.FormEventMapping.GetDisplayName() },
                    { "format", format.GetDisplayName() },
                    { "returnFormat", returnFormat.GetDisplayName() }
                };
                // Add all optional parameters
        ...
        /// <param name="returnFormat">csv, json, xml - specifies the format of error messages. If you do not pass in this flag, it will select the default format for you passed based on the 'format' flag you passed in or if no format flag was passed in, it will default to 'json'.</param>
        /// <returns>Instrument-event mappings for the project in the format specified</returns>
        public async Task<string> ExportInstrumentMappingAsync(string token, RedcapContent content, RedcapFormat format, string[] arms = default, RedcapReturnFormat returnFormat = RedcapReturnFormat.json)
        {
            try
            {
                /*
        ...
        /// <param name="returnFormat">csv, json, xml - specifies the format of error messages. If you do not pass in this flag, it will select the default format for you passed based on the 'format' flag you passed in or if no format flag was passed in, it will default to 'json'.</param>
        /// <returns>Number of Instrument-Event Mappings imported</returns>
        public async Task<string> ImportInstrumentMappingAsync<T>(string token, RedcapContent content, RedcapFormat format, List<T> data, RedcapReturnFormat returnFormat = RedcapReturnFormat.json)
        {
            try
            {
                /*
        ...
        public async Task<string> ExportMetaDataAsync(string token, RedcapContent content, RedcapFormat format, string[] fields = default, string[] forms = default, RedcapReturnFormat returnFormat = RedcapReturnFormat.json)
        {
            try
            {
                /*
        ...
        public async Task<string> ExportMetaDataAsync(string token, RedcapFormat format = RedcapFormat.json, string[] fields = default, string[] forms = default, RedcapReturnFormat returnFormat = RedcapReturnFormat.json)
        {
            try
            {
                ...
                {
                    { "token", token },
                    { "content", RedcapContent.MetaData.GetDisplayName() },
                    { "format", format.GetDisplayName() },
                    { "returnFormat", returnFormat.GetDisplayName() }
                };
                // Optional
        ...
        /// <param name="returnFormat">csv, json, xml - specifies the format of error messages. If you do not pass in this flag, it will select the default format for you passed based on the 'format' flag you passed in or if no format flag was passed in, it will default to 'json'.</param>
        /// <returns>Number of fields imported</returns>
        public async Task<string> ImportMetaDataAsync<T>(string token, RedcapContent content, RedcapFormat format, List<T> data, RedcapReturnFormat returnFormat = RedcapReturnFormat.json)
        {
            try
            {
                /*
        ...
        public async Task<string> CreateProjectAsync<T>(string token, RedcapFormat format, List<T> data, RedcapReturnFormat returnFormat = RedcapReturnFormat.json, string odm = default)
        {
            try
            {
                ...
                {
                    { "token", token },
                    { "content", RedcapContent.Project.GetDisplayName() },
                    { "format", format.GetDisplayName() },
                    { "returnFormat", returnFormat.GetDisplayName() },
                    { "data", _serializedData }
                };
        ...
        /// <param name="odm">default: NULL - The 'odm' parameter must be an XML string in CDISC ODM XML format that contains project metadata (fields, forms, events, arms) and might optionally contain data to be imported as well. The XML contained in this parameter can come from a REDCap Project XML export file from REDCap itself, or may come from another system that is capable of exporting projects and data in CDISC ODM format. If the 'odm' parameter is included in the API request, it will use the XML to import its contents into the newly created project. This will allow you not only to create the project with the API request, but also to import all fields, forms, and project attributes (and events and arms, if longitudinal) as well as record data all at the same time.</param>
        /// <returns>When a project is created, a 32-character project-level API Token is returned (associated with both the project and user creating the project). This token could then ostensibly be used to make subsequent API calls to this project, such as for adding new events, fields, records, etc.</returns>
        public async Task<string> CreateProjectAsync<T>(string token, RedcapContent content, RedcapFormat format, List<T> data, RedcapReturnFormat returnFormat = RedcapReturnFormat.json, string odm = null)
        {
            try
            {
                /*
        ...
        public async Task<string> ImportProjectInfoAsync(string token, RedcapContent content, RedcapFormat format, RedcapProjectInfo projectInfo)
        {
            try
            {
                /*
        ...
        public async Task<string> ImportProjectInfoAsync(string token, RedcapFormat format, RedcapProjectInfo projectInfo)
        {
            try
            {
                ...
                {
                    { "token", token },
                    { "content", RedcapContent.ProjectSettings.GetDisplayName() },
                    { "format", format.GetDisplayName() },
                    { "data", _serializedData }
                };
                return await this.SendPostRequestAsync(payload, _uri);
        ...
        /// </returns>
        public async Task<string> ExportProjectInfoAsync(string token, RedcapContent content = RedcapContent.Project, RedcapFormat format = RedcapFormat.json, RedcapReturnFormat returnFormat = RedcapReturnFormat.json)
        {
            try
            {
                /*
        ...
        public async Task<string> ExportProjectXmlAsync(string token, bool returnMetadataOnly = false, string[] records = default, string[] fields = default, string[] events = default, RedcapReturnFormat returnFormat = RedcapReturnFormat.json, bool exportSurveyFields = false, bool exportDataAccessGroups = false, string filterLogic = default, bool exportFiles = false)
        {
            try
            {
                ...
                {
                    { "token", token },
                    { "content", RedcapContent.ProjectXml.GetDisplayName() },
                    { "returnFormat", returnFormat.GetDisplayName() }
                };
                // Optional
                if (returnMetadataOnly)
        ...
        public async Task<string> GenerateNextRecordNameAsync(string token)
        {
            try
            {
                ...
                {
                    { "token", token },
                    { "content", RedcapContent.GenerateNextRecordName.GetDisplayName() },
                };
                return await this.SendPostRequestAsync(payload, _uri);
            }
            catch (Exception Ex)
        ...
        /// <returns>The maximum integer record ID + 1.</returns>
        public async Task<string> GenerateNextRecordNameAsync(string token, RedcapContent content)
        {
            try
            {
                /*
        ...
        public async Task<string> ExportRecordsAsync(string token, RedcapFormat format = RedcapFormat.json, RedcapDataType redcapDataType = RedcapDataType.flat, string[] records = default, string[] fields = default, string[] forms = default, string[] events = default, RawOrLabel rawOrLabel = RawOrLabel.raw, RawOrLabelHeaders rawOrLabelHeaders = RawOrLabelHeaders.raw, bool exportCheckboxLabel = false, RedcapReturnFormat returnFormat = RedcapReturnFormat.json, bool exportSurveyFields = false, bool exportDataAccessGroups = false, string filterLogic = null, DateTime? dateRangeBegin = default, DateTime? dateRangeEnd = default, string csvDelimiter = default, string decimalCharacter = default, bool exportBlankForGrayFormStatus = false)
        {
            try
            {
                ...
                {
                    { "token", token },
                    { "content", RedcapContent.Record.GetDisplayName() },
                    { "format", format.GetDisplayName() },
                    { "returnFormat", returnFormat.GetDisplayName() },
        ...
        /// (This can only be used if the project is longitudinal with more than one arm.) NOTE: If the arm parameter is not provided, the specified records will be deleted from all arms in which they exist. Whereas, if arm is provided, they will only be deleted from the specified arm. </param>
        /// <returns>the number of records deleted or (if instrument, event, and/or instance are provided) the number of items deleted over the total records specified.</returns>
        public async Task<string> DeleteRecordsAsync(string token, RedcapContent content, RedcapAction action, string[] records, int? arm)
        {
            try
            {
                /*
        ...
        /// <returns>the number of records deleted or (if instrument, event, and/or instance are provided) the number of items deleted over the total records specified.</returns>
        public async Task<string> DeleteRecordsAsync(string token, RedcapContent content, RedcapAction action, string[] records, int? arm, RedcapInstrument instrument, RedcapEvent redcapEvent, RedcapRepeatInstance repeatInstance)
        {
            try
            {
                /*
        ...
        public async Task<string> RenameRecordAsync(string token, RedcapContent content, RedcapAction action, string record, string newRecordName, int? arm)
        {
            try
            {
                /*
        ...
        public async Task<string> ExportRepeatingInstrumentsAndEvents(string token, RedcapFormat format = RedcapFormat.json)
        {
            try
            {
                ...
                {
                    { "token", token },
                    { "content", RedcapContent.RepeatingFormsEvents.GetDisplayName() },
                    { "format", format.GetDisplayName() }
                };
                return await this.SendPostRequestAsync(payload, _uri);
            }
        ...
        /// <param name="format">csv, json [default], xml odm ('odm' refers to CDISC ODM XML format, specifically ODM version 1.3.1)</param>
        /// <returns>Repeated instruments and events for the project in the format specified and will be ordered according to their order in the project.</returns>
        public async Task<string> ExportRepeatingInstrumentsAndEvents(string token, RedcapContent content, RedcapFormat format = RedcapFormat.json)
        {
            try
            {
                /*
        ...
        /// <param name="returnFormat">csv, json, xml - specifies the format of error messages. If you do not pass in this flag, it will select the default format for you passed based on the 'format' flag you passed in or if no format flag was passed in, it will default to 'json'.</param>
        /// <returns>Repeated instruments and events for the project in the format specified and will be ordered according to their order in the project.</returns>
        public async Task<string> ImportRepeatingInstrumentsAndEvents<T>(string token, List<T> data, RedcapContent content = RedcapContent.RepeatingFormsEvents, RedcapFormat format = RedcapFormat.json, RedcapReturnFormat returnFormat = RedcapReturnFormat.json)
        {
            try
            {
                /*
        ...
        public async Task<string> ExportReportsAsync(string token, int reportId, RedcapFormat format = RedcapFormat.json, RedcapReturnFormat returnFormat = RedcapReturnFormat.json, RawOrLabel rawOrLabel = RawOrLabel.raw, RawOrLabelHeaders rawOrLabelHeaders = RawOrLabelHeaders.raw, bool exportCheckboxLabel = false, string csvDelimiter = default, string decimalCharacter = default)
        {
            try
            {
                ...
                {
                    { "token", token },
                    { "content", RedcapContent.Report.GetDisplayName() },
        ...
        /// <param name="decimalCharacter"></param>
        /// <returns>Data from the project in the format and type specified ordered by the record (primary key of project) and then by event id</returns>
        public async Task<string> ExportReportsAsync(string token, RedcapContent content, int reportId, RedcapFormat format = RedcapFormat.json, RedcapReturnFormat returnFormat = RedcapReturnFormat.json, RawOrLabel rawOrLabel = RawOrLabel.raw, RawOrLabelHeaders rawOrLabelHeaders = RawOrLabelHeaders.raw, bool exportCheckboxLabel = false, string csvDelimiter = default, string decimalCharacter = default)
        {
            try
            {
                /*
        ...
        public async Task<string> ExportRedcapVersionAsync(string token, RedcapContent content = RedcapContent.Version, RedcapFormat format = RedcapFormat.json)
        {
            try
            {
                /*
        ...
        public async Task<string> ExportRedcapVersionAsync(string token, RedcapFormat format = RedcapFormat.json)
        {
            try
            {
                ...
                {
                    { "token", token },
                    { "content", RedcapContent.Version.GetDisplayName() },
                    { "format", format.GetDisplayName() }
                };
        ...
        public async Task<string> ExportSurveyLinkAsync(string token, string record, string instrument, string eventName, int repeatInstance, RedcapReturnFormat returnFormat = RedcapReturnFormat.json)
        {
            try
            {
                ...
                {
                    { "token", token },
                    { "content", RedcapContent.SurveyLink.GetDisplayName() },
                    { "record", record },
        ...
        /// <param name="returnFormat">csv, json [default], xml - The returnFormat is only used with regard to the format of any error messages that might be returned.</param>
        /// <returns>Returns a unique survey link (i.e., a URL) in plain text format for the specified record and instrument (and event, if longitudinal).</returns>
        public async Task<string> ExportSurveyLinkAsync(string token, RedcapContent content, string record, string instrument, string eventName, int repeatInstance, RedcapReturnFormat returnFormat = RedcapReturnFormat.json)
        {
            try
            {
                /*
        ...
        public async Task<string> ExportSurveyParticipantsAsync(string token, string instrument, string eventName, RedcapFormat format = RedcapFormat.json, RedcapReturnFormat returnFormat = RedcapReturnFormat.json)
        {
            try
            {
                ...
                {
                    { "token", token },
                    { "content", RedcapContent.ParticipantList.GetDisplayName() },
                    { "format", format.GetDisplayName() },
                    { "instrument", instrument },
                    { "event", eventName },
                    { "returnFormat", returnFormat.GetDisplayName() }
        ...
        /// <param name="returnFormat">csv, json, xml - specifies the format of error messages. If you do not pass in this flag, it will select the default format for you passed based on the 'format' flag you passed in or if no format flag was passed in, it will default to 'json'.</param>
        /// <returns>Returns the list of all participants for the specified survey instrument [and event] in the desired format. The following fields are returned: email, email_occurrence, identifier, invitation_sent_status, invitation_send_time, response_status, survey_access_code, survey_link. The attribute 'email_occurrence' represents the current count that the email address has appeared in the list (because emails can be used more than once), thus email + email_occurrence represent a unique value pair. 'invitation_sent_status' is '0' if an invitation has not yet been sent to the participant, and is '1' if it has. 'invitation_send_time' is the date/time in which the next invitation will be sent, and is blank if there is no invitation that is scheduled to be sent. 'response_status' represents whether the participant has responded to the survey, in which its value is 0, 1, or 2 for 'No response', 'Partial', or 'Completed', respectively. Note: If an incorrect event_id or instrument name is used or if the instrument has not been enabled as a survey, then an error will be returned.</returns>
        public async Task<string> ExportSurveyParticipantsAsync(string token, RedcapContent content, string instrument, string eventName, RedcapFormat format = RedcapFormat.json, RedcapReturnFormat returnFormat = RedcapReturnFormat.json)
        {
            try
            {
                /*
        ...
        public async Task<string> ExportSurveyQueueLinkAsync(string token, string record, RedcapReturnFormat returnFormat = RedcapReturnFormat.json)
        {
            try
            {
                ...
                {
                    { "token", token },
                    { "content", RedcapContent.SurveyQueueLink.GetDisplayName() },
                    { "record", record },
                    { "returnFormat", returnFormat.GetDisplayName() }
                };
        ...
        /// <param name="returnFormat">csv, json, xml - specifies the format of error messages. If you do not pass in this flag, it will select the default format for you passed based on the 'format' flag you passed in or if no format flag was passed in, it will default to 'json'.</param>
        /// <returns>Returns a unique Survey Queue link (i.e., a URL) in plain text format for the specified record in the project.</returns>
        public async Task<string> ExportSurveyQueueLinkAsync(string token, RedcapContent content, string record, RedcapReturnFormat returnFormat = RedcapReturnFormat.json)
        {
            try
            {
                /*
        ...
        public async Task<string> ExportSurveyReturnCodeAsync(string token, string record, string instrument, string eventName, string repeatInstance, RedcapReturnFormat returnFormat = RedcapReturnFormat.json)
        {
            try
            {
                ...
                {
                    { "token", token },
                    { "content", RedcapContent.SurveyReturnCode.GetDisplayName() },
                    { "record", record },
                    { "instrument", instrument },
                    { "event", eventName },
                    { "repeat_instance", repeatInstance.ToString()},
        ...
        /// <param name="returnFormat">csv, json, xml - specifies the format of error messages. If you do not pass in this flag, it will select the default format for you passed based on the 'format' flag you passed in or if no format flag was passed in, it will default to 'json'.</param>
        /// <returns>Returns a unique Return Code in plain text format for the specified record and instrument (and event, if longitudinal).</returns>
        public async Task<string> ExportSurveyReturnCodeAsync(string token, RedcapContent content, string record, string instrument, string eventName, string repeatInstance, RedcapReturnFormat returnFormat = RedcapReturnFormat.json)
        {
            try
            {
                /*
        ...
        public async Task<string> ExportUsersAsync(string token, RedcapFormat format = RedcapFormat.json, RedcapReturnFormat returnFormat = RedcapReturnFormat.json)
        {
            try
            {
                ...
                {
                    { "token", token },
                    { "content", RedcapContent.User.GetDisplayName() },
                    { "format", format.GetDisplayName() },
                    { "returnFormat", returnFormat.GetDisplayName() }
                };
        ...
        /// username, email, firstname, lastname, expiration, data_access_group, design, user_rights, data_access_groups, data_export, reports, stats_and_charts, manage_survey_participants, calendar, data_import_tool, data_comparison_tool, logging, file_repository, data_quality_create, data_quality_execute, api_export, api_import, mobile_app, mobile_app_download_data, record_create, record_rename, record_delete, lock_records_customization, lock_records, lock_records_all_forms, forms</returns>
        /// 
        public async Task<string> ExportUsersAsync(string token, RedcapContent content = RedcapContent.User, RedcapFormat format = RedcapFormat.json, RedcapReturnFormat returnFormat = RedcapReturnFormat.json)
        {
            try
            {
                /*
        ...
        /// <param name="returnFormat">csv, json, xml - specifies the format of error messages. If you do not pass in this flag, it will select the default format for you passed based on the 'format' flag you passed in or if no format flag was passed in, it will default to 'json'.</param>
        /// <returns>Number of users added or updated</returns>
        public async Task<string> ImportUsersAsync<T>(string token, RedcapContent content, List<T> data, RedcapFormat format = RedcapFormat.json, RedcapReturnFormat returnFormat = RedcapReturnFormat.json)
        {
            try
            {
                /*
        ...
        public async Task<string> DeleteUsersAsync(string token, List<string> users, RedcapContent content = RedcapContent.User, RedcapAction action = RedcapAction.Delete)
        {
            try
            {
                /*
        ...
        /// 
        /// </example>
        public async Task<string> ExportUserRolesAsync(string token, RedcapContent content = RedcapContent.UserRole, RedcapFormat format = RedcapFormat.json, RedcapReturnFormat returnFormat = RedcapReturnFormat.json)
        {
            try
            {
                /*
        ...
        public async Task<string> ImportUserRolesAsync<T>(string token, List<T> data, RedcapContent content = RedcapContent.UserRole,  RedcapFormat format = RedcapFormat.json, RedcapReturnFormat returnFormat = RedcapReturnFormat.json)
        {
        ...
        public async Task<string> DeleteUserRolesAsync(string token, List<string> roles, RedcapContent content = RedcapContent.UserRole, RedcapAction action = RedcapAction.Delete)
        {
        ...
        public async Task<string> ExportUserRoleAssignmentAsync(string token, RedcapContent content = RedcapContent.UserRoleMapping, RedcapFormat format = RedcapFormat.json, RedcapReturnFormat onErrorFormat = RedcapReturnFormat.json)
        {
        ...
        public async Task<string> ImportUserRoleAssignmentAsync<T>(string token, List<T> data, RedcapContent content = RedcapContent.UserRoleMapping, RedcapAction action = RedcapAction.Import, RedcapFormat format = RedcapFormat.json, RedcapReturnFormat onErrorFormat = RedcapReturnFormat.json)
        {
