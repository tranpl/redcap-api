...
namespace Redcap.Interfaces
{
    ...
    public interface IRedcap
    {
        ...
        /// </summary>
        /// <returns></returns>
        Task<string> ImportFileAsync(string record, string field, string eventName, string repeatInstance, string filePath, ReturnFormat returnFormat = ReturnFormat.json);
        /// <summary>
        /// Not implemented
        /// </summary>
        /// <returns></returns>
